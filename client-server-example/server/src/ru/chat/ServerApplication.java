...
public class ServerApplication {
    ...
    public static void choose(String message) {
        switch (message) {
            case "sing", "Sing", "SING" -> writeChosen(CHRISTMAS_SONG);
            case "draw", "Draw", "DRAW" -> writeChosen(BUNNY);
            case "bath", "Bath", "BATH" -> writeChosen("Just kidding! \uD83D\uDE04 I'm not waterproof.");
            case "sleep", "Sleep", "SLEEP" -> {
                writeChosen("I'll sing you a lullaby:");
                writeChosen(LULLABY);
            }
            case "exit", "Exit", "EXIT" -> writeChosen("Hope to see you later! Bye! \uD83D\uDC4B");
            default -> writeChosen("\uD83D\uDE00I'm sorry, but I don't understand you. Please, try again.\uD83E\uDD17");
        }
    }
